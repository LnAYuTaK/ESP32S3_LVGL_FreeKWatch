...
typedef struct {
    lv_state_t     state;
    lv_style_t topPadding;
    lv_style_t bottomPadding;
    lv_style_t leftPadding;
    lv_style_t rightPadding;
    lv_style_t innerPadding;
} PaddingStyle_t;

typedef struct {
    lv_state_t state;
    lv_style_t topMargin;
    lv_style_t bottomMargin;
    lv_style_t leftMargin;
    lv_style_t rightMargin;
} MarginStyle_t;
...
typedef struct {
    ...
    lv_font_t*      textFont;
    lv_style_t  textLetterSpacing;
    lv_style_t  textLineSpacing;
